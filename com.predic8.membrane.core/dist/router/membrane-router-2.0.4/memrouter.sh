...
CLASSPATH=$CLASSPATH:$MEMBRANE_HOME/lib/commons-logging.jar
CLASSPATH=$CLASSPATH:$MEMBRANE_HOME/lib/ffmq3-core.jar
CLASSPATH=$CLASSPATH:$MEMBRANE_HOME/lib/jms-1.1.jar
