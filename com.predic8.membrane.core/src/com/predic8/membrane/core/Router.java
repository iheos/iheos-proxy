...
public class Router {
	...
	protected static DNSCache dnsCache;// = new DNSCache();
	...
	public static Router init(String resource, ClassLoader classLoader) {
		...
		dnsCache = (DNSCache) beanFactory.getBean("dnsCache");
		try {
			dnsCache.setAppCache((ApplicationCachePreLoader)beanFactory.getBean("appPreLoader"));
		} catch (NoSuchBeanDefinitionException nsbe) {
			log.info("Ingoring app cache preload init");			
		}
	...
	/**
	 * @param dnsCache the dnsCache to set
	 */
